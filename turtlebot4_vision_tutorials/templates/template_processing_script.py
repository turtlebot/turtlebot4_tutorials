...
def torso_visible(scores):
    ...
    # Ignoring linting for the following template lines:
    return ((scores[11] > ${_score_thresh} or  # noqa: E999
             scores[12] > ${_score_thresh}) and  # noqa: E999
            (scores[5] > ${_score_thresh} or  # noqa: E999
             scores[6] > ${_score_thresh}))  # noqa: E999
